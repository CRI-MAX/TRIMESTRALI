...
if not cliente_opzioni:
    st.warning("⚠️ Nessun cliente disponibile. Inseriscine uno prima.")
    st.stop()

if not tipo_opzioni:
    st.warning("⚠️ Nessun tipo di scadenza disponibile. Inseriscine uno prima.")
    st.stop()
